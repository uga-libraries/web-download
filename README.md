...
wget, for downloading content using a URL. To install in Windows:
...
You need administrative priviledges on your machine for the script to be able to use wget. Additionally, Windows install instructions recommend saving to the System32 folder, which is already in the Path, but the Python script cannot access wget in this location.
