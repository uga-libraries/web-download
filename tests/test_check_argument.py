...
class MyTestCase(unittest.TestCase):
    ...
    def test_correct(self):
        ...
        arg_list = ['merge_csvs.py', os.path.join(os.getcwd(), 'merge', 'test_data', 'check_arguments')]
    ...
    def test_file_error(self):
        ...
        arg_list = ['merge_csvs.py', os.path.join(os.getcwd(), 'merge', 'test_data', 'check_arguments', 'File.txt')]
        csv_directory, error = check_argument(arg_list)
    ...
    def test_path_error(self):
        ...
        arg_list = ['merge_csvs.py', os.path.join(os.getcwd(), 'merge', 'test_data', 'check_arguments', 'MISSING')]
        csv_directory, error = check_argument(arg_list)
